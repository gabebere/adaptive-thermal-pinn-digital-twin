...
class WorkflowConfig:
    ...
    # Four sensors along the 2-D centerline, analogous to the four 1-D sensors.
    # The first is slightly interior because x=0 is a prescribed Dirichlet edge.
    sensor_x: tuple[float, ...] = (0.05, 0.25, 0.5, 0.75)
    sensor_y: tuple[float, ...] = (0.5,)
    # 41 instances in batches of 9 produce five streaming update windows.
    batch_size_n: int = 9
    ...
    adaptive_iterations_per_batch: int = 160
