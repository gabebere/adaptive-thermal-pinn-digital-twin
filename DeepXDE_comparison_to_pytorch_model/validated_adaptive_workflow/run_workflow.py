...
from parameters import MAINTAINED_ADAPTIVE_PROFILES, config_for_adaptive_profile, make_config
...
def main():
    ...
    parser.add_argument(
        ...
        default="balanced",
        help="maintained online configuration (default: balanced)",
    )
    parser.add_argument("--paper-tables-dir", type=Path)
    parser.add_argument("--output-dir", type=Path)
    args = parser.parse_args()

    cfg = config_for_adaptive_profile(make_config(args.profile), args.adaptive_profile)
    ...
    output_dir = (
        ...
        if args.adaptive_profile == "balanced"
        else cfg.output_dir / args.adaptive_profile / args.profile
    )
