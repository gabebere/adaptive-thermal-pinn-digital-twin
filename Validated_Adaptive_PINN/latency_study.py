...
def _plot_results(results, output_dir, switch_tau):
    ...
    axes[0].set(
        ...
        xlabel="tau",
        ylabel="full-field RMSE before update",
        yscale="log",
    ...
    axes[1].set(
        ...
        xlabel="tau after boundary change (lower is faster)",
    )
    ...
    axes[2].set(
        ...
        ylabel="post-switch causal full-field RMSE",
    )
    for ax in axes:
        ax.grid(alpha=0.25)
    fig.suptitle(
...
def run_study(profile: str, output_dir: Path):
    ...
    summary = {
        ...
        "recommended_configuration": ranked[0]["name"],
        "experiments": results,
    }
    ...
    print(f"Recommended configuration: {ranked[0]['name']}")
...
def recalculate_saved_results(output_dir: Path):
    ...
    summary["recommended_configuration"] = ranked[0]["name"]
...
def main():
    ...
    if args.recalculate_existing:
        ...
        run_study(args.profile, output_dir)
